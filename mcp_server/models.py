...
class ConfigChange(BaseModel):
    advices: Optional[List[Advice]] = Field(
        None,
...
class ConfigFile(BaseModel):
    fileContents: Optional[str] = Field(
        None, description='The bytes that constitute the file.'
    )
    ...
    fileType: Optional[FileType] = Field(
        None, description='The type of configuration file this represents.'
    )
...
class ConfigSource(BaseModel):
    files: Optional[List[ConfigFile]] = Field(
        None,
...
class DeleteServiceStrategy(BaseModel):
    pass
...
class Diagnostic(BaseModel):
    kind: Optional[Kind] = Field(
        None, description='The kind of diagnostic information provided.'
    )
    location: Optional[str] = Field(
        None, description='File name and line number of the error or warning.'
    )
    message: Optional[str] = Field(
        None, description='Message describing the error or warning.'
    )
...
class FlowErrorDetails(BaseModel):
    exceptionType: Optional[str] = Field(
        None, description='The type of exception (as a class name).'
    )
    flowStepId: Optional[str] = Field(None, description='The step that failed.')


class GenerateConfigReportRequest(BaseModel):
    newConfig: Optional[Dict[str, Any]] = Field(
        None,
    ...
    oldConfig: Optional[Dict[str, Any]] = Field(
        None,
...
class Step(BaseModel):
    description: Optional[str] = Field(
        None, description='The short description of the step.'
    )
    status: Optional[Status2] = Field(None, description='The status code.')


class SubmitConfigSourceRequest(BaseModel):
    configSource: Optional[ConfigSource] = Field(
        None, description='Required. The source configuration for the service.'
    )
...
class TrafficPercentStrategy(BaseModel):
    percentages: Optional[Dict[str, float]] = Field(
        None,
...
class UndeleteServiceResponse(BaseModel):
    service: Optional[ManagedService] = Field(
        None, description='Revived service resource.'
    )
...
class ChangeReport(BaseModel):
    configChanges: Optional[List[ConfigChange]] = Field(
        None,
...
class FieldModel(BaseModel):
    ...
    kind: Optional[Kind1] = Field(None, description='The field type.')
...
class GenerateConfigReportResponse(BaseModel):
    changeReports: Optional[List[ChangeReport]] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None, description='ID of the service configuration this report belongs to.'
    )
    serviceName: Optional[str] = Field(
        None, description='Name of the service this report belongs to.'
    )
...
class ListServicesResponse(BaseModel):
    ...
    services: Optional[List[ManagedService]] = Field(
        None, description='The returned services will only have the name field set.'
    )
...
class OperationMetadata(BaseModel):
    progressPercentage: Optional[int] = Field(
        None,
...
class Rollout(BaseModel):
    createTime: Optional[str] = Field(
        None, description='Creation time of the rollout. Readonly.'
    )
    createdBy: Optional[str] = Field(
        None, description='The user who created the Rollout. Readonly.'
    )
    deleteServiceStrategy: Optional[DeleteServiceStrategy] = Field(
        None,
    ...
    serviceName: Optional[str] = Field(
        None, description='The name of the service associated with this Rollout.'
    )
    ...
    trafficPercentStrategy: Optional[TrafficPercentStrategy] = Field(
        None,
...
class ListServiceRolloutsResponse(BaseModel):
    nextPageToken: Optional[str] = Field(
        None, description='The token of the next page of results.'
    )
    rollouts: Optional[List[Rollout]] = Field(
        None, description='The list of rollout resources.'
    )
...
class SubmitConfigSourceResponse(BaseModel):
    serviceConfig: Optional[Service] = Field(
        None, description='The generated service configuration.'
    )
...
class ListServiceConfigsResponse(BaseModel):
    ...
    serviceConfigs: Optional[List[Service]] = Field(
        None, description='The list of service configuration resources.'
    )
